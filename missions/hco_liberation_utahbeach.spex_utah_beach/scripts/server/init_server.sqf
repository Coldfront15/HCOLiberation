...
addMissionEventHandler ["PlayerConnected", {
    ...
    [_name, "joined", _uid, "_owner"] remoteExec ["KPLIB_fnc_logDiscordEvent", 2]; // call on server
}];

addMissionEventHandler ["PlayerDisconnected", {
    params ["_id", "_uid", "_name", "_jip", "_owner"];
    [_name, "left", _uid] remoteExec ["KPLIB_fnc_logDiscordEvent", 2];
}];
...
execVM "arsenal_presets\default_loadouts.sqf";
