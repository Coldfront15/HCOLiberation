...
[
    ...
    [
        [
            format ["Our forces have liberated %1 ", markerText _liberated_sector], // Player has joined/left the server
            "A victory to all our forces, keep the effort going!", // desc of some kind or skip?
            "",
            "",
            true,
            "",
            "https://i.imgur.com/jCAJObV.jpeg",
            [],
            [],
            []
        ]
