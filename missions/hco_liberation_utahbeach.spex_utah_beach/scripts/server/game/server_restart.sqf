    ...
    switch true do
    {
        case ((_timeUntilRestart < (1 * 60)) && !_60secondspassed) :
        {
            ...
            [
                ...
                [
                    [
                        "Restarting Server", // Player has joined/left the server
                        "Server will restart momentarily.", // desc of some kind or skip?
                        "",
                        "",
                        true,
                        "",
                        ...
                        [],
                        [
                            ["KIA:",format ["%1 friendlies killed.", stats_player_deaths],true],
                            ["EKIA:",format ["%1 enemies killed.", stats_opfor_killed_by_players],true], 
                            ["SECTORS:",format ["Liberated %1 sectors.", stats_sectors_liberated],true]
                        ]
                    ]
                ]
        ...
        case ((_timeUntilRestart < (30 * 60)) && !_30minspassed) :
        {
            ...
            [
                ...
                [
                    [
                        "Restarting Server", // Player has joined/left the server
                        "30 Minutes until server restart", // desc of some kind or skip?
                        "",
                        "",
                        true,
                        "",
