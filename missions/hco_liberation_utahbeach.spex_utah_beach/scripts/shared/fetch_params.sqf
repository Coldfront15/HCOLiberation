...
if(isServer) then {
    ...
    GET_PARAM(KP_liberation_allowEnemiesInImmobileForver, "AllowEnemiesInImmobileForever", 50);
...
switch (GRLIB_difficulty_modifier) do {
    case 0: {GRLIB_difficulty_modifier = 1;};
    case 1: {GRLIB_difficulty_modifier = 2;};
    case 2: {GRLIB_difficulty_modifier = 3;};
    case 3: {GRLIB_difficulty_modifier = 4;};
    case 4: {GRLIB_difficulty_modifier = 5;};
    case 5: {GRLIB_difficulty_modifier = 6;};
    case 6: {GRLIB_difficulty_modifier = 8;};
    case 7: {GRLIB_difficulty_modifier = 10;};
    default {GRLIB_difficulty_modifier = 1;};
};

switch (GRLIB_csat_aggressivity) do {
    case 0: {GRLIB_csat_aggressivity = 2;};
    case 1: {GRLIB_csat_aggressivity = 3;};
    case 2: {GRLIB_csat_aggressivity = 4;};
    case 3: {GRLIB_csat_aggressivity = 5;};
    case 4: {GRLIB_csat_aggressivity = 6;};
...
if (!isDedicated && hasInterface) then {
    ...
    _value = if (KP_liberation_allowEnemiesInImmobileForever == 0) then {localize "STR_PARAMS_DISABLED";} else {KP_liberation_allowEnemiesInImmobileForever;};
    _text = _text + format ["<font color='#ff8000'>%1</font><br />%2<br /><br />", _param, _value];
