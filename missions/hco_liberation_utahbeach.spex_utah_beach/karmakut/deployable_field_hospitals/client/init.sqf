...
karma_deployableFieldHospitals_client_actionDurationInSeconds = 30; // This can't be longer than 24 seconds (limitation of the BIS_fnc_holdActionAdd function).
...
karma_deployableFieldHospitals_client_initializePlayer = {
    private _deployActionId = [
        ...
        "
            ...
            (roleDescription player) find 'Platoon Medic' > -1 &&
