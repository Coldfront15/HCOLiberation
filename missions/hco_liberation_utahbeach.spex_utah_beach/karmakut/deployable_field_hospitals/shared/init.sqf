...
karma_deployableFieldHospitals_shared_fieldHospitalClassname = "cwa_Stretcher"; // make sure to keep this in-sync with the associated entry in `KP_liberation_medical_facilities`.
