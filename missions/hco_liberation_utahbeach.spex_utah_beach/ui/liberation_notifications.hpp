class CfgNotifications {
    ...
    class lib_admin_notification: lib_default_notification {
        title = "%1";
        description = "%2";
        iconPicture = "%3";
        sound = "taskUpdated";
    ...
    class lib_intel_artillery: lib_intel {
        description = $STR_NOTIFICATION_ARTILLERY_TEXT;
    };
    ...
    class lib_reinforcements: lib_default_notification {
        title = "HOSTILE REINFORCEMENTS";
        description = "Airborne troops are reinforcing %1.";
